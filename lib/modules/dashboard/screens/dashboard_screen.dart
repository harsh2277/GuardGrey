...
import 'package:guardgrey/modules/clients/screens/client_detail_screen.dart';
import 'package:guardgrey/modules/clients/screens/clients_screen.dart';
import 'package:guardgrey/modules/dashboard/widgets/kpi_card.dart';
import 'package:guardgrey/modules/managers/models/manager_model.dart';
import 'package:guardgrey/modules/managers/screens/manager_detail_screen.dart';
...
import 'package:guardgrey/modules/sites/screens/site_detail_screen.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  List<AttendanceRecord> _todayAttendance(List<AttendanceRecord> records) {
    final todayLabel = FirestoreAdminRepository.formatDate(DateTime.now());
    return records
  ...
  void _openTabOrPush(BuildContext context, int tabIndex, Widget fallbackPage) {
    ...
    if (context.findAncestorWidgetOfExactType<MainNavigation>() != null) {
      MainNavigation.switchToTab(context, tabIndex);
      return;
    }
